...
const projects = [
  ...
  },
  {
    ...
    demoUrl: "https://athenix-ai.vercel.app/",
  ...
  return (
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
       ...
       Here are a few of my recent projects, each built with a focus on clean design, efficient performance, and an intuitive user experience.
        </p>
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            href="https://github.com/AmnaRehan"
          >
